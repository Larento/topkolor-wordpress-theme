...
function load_scripts()
{
  ...
  if (is_page_template('page-request.php')) load_script('topkolor', 'request-form');
  if (is_front_page()) load_script('topkolor', 'home-slideshow');
  load_script('topkolor', 'portfolio-browser');
